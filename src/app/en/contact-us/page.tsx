...
const PAGE_KEY = "en-contact-us";

export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact Fair Direction, the authorized sales agent for Qatar Diar's projects in Egypt, by form, phone, or email to ask about projects and payment plans.",
  alternates: { canonical: "/en/contact-us/" },
};
      ...
      <section className="bg-qd-cream py-[70px] max-[767px]:py-[40px]">
        <Container>
          <div className="grid gap-[50px] lg:grid-cols-2">
            <ContactForm title="Send a Message" locale="en" />
