...
export function SiteFooter() {
  return (
    <footer className="qd-footer bg-qd-navy pt-[90px]">
      ...
      {/* gac:start:footer-ar */}
      <div className="mx-auto max-w-[1280px] px-[40px] pb-[24px]">
        <p className="text-[12px] leading-[20px] text-white/70">
          Fair Direction is an independent and authorized sales agent for Qatar
          Diar properties. This is not the official website of Qatar Diar Real
          Estate Investment.
        </p>
